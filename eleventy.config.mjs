...
export default function (config) {
  ...
  config.addLiquidShortcode('modal-body', function () {
    return `<div class="usa-modal" id="modal-start-application" aria-labelledby="modal-start-application-heading" aria-describedby="modal-start-application-description"><div class="usa-modal__content"><div class="usa-modal__main"><h2 class="usa-modal__heading h3" id="modal-start-application-heading">Before you request a .gov domain</h2><div class="usa-prose"><p>You're about to start a request for a .gov domain. Domains are approved only for authorized requesters from <a href="https://get.gov/domains/eligibility/">eligible U.S.-based government organizations</a> that meet our <a href="https://get.gov/domains/choosing/">naming requirements</a>.</p><ul><li><strong>Non-federal organizations</strong>: You must be a government employee or work on behalf of the government in a technological, administrative, or executive capacity.</li><li><strong>Federal organizations</strong>: These agencies limit who can submit requests on their behalf. Federal employees should coordinate with their CIO office to obtain the appropriate internal approvals.</li></ul><p>Before you request a domain, you must have a <a href="https://login.gov/help/get-started/create-your-account/" class="usa-link--external">Login.gov account</a> and verify your identity. This is a necessary layer of security that requires you to prove you are you, and not someone pretending to be you. You’ll then use your Login.gov account to sign in to the .gov registrar.</p><p>If you have <a href="https://get.gov/domains/before/#information-you-will-need-to-complete-the-domain-request">the information you need</a>, this might take around 15 minutes.</p></div><div class="usa-modal__footer"><ul class="usa-button-group"><li class="usa-button-group__item"><a class="usa-button" href="https://manage.get.gov/request/start/">Continue to Login.gov</a></li><li class="usa-button-group__item"><button type="button" class="usa-button usa-button--unstyled padding-105 text-center" data-close-modal>Cancel</button></li></ul></div></div><button type="button" class="usa-button usa-modal__close" aria-label="Close this window" data-close-modal><svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use xlink:href="#svg-close"></use></svg></button></div></div>`;
  });
