...
### A pause on new .gov domain requests {.h4}
...
### *If you requested a .gov domain* {.h4}
...
### *If you already have a .gov domain* {.h4}
...
### Does this mean that all .gov websites will shut down for three months? {.h4}
...
### Can we launch new subdomains on .gov sites? {.h4}
...
### What if some .gov domain managers don't create Login.gov accounts? {#what-if-some-gov-domain-managers-do-not-create-login-gov-accounts .h4}
