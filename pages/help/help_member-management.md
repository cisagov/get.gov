...
| Domain requests | Member’s [permission level](../../member-management/#understanding-enterprise-mode-roles-and-permissions) to view and create domain requests (No access, Requester, Viewer) |
| Members | Member’s [permission level](../../member-management/#understanding-enterprise-mode-roles-and-permissions) to view or manage member permissions (No access, Manager, Viewer) |
| Domains | Member’s [permission level](../../member-management/#understanding-enterprise-mode-roles-and-permissions) to view domains for their organization (Viewer; Viewer, limited) |
