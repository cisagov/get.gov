...
Sign in to the [.gov registrar](https://manage.get.gov/) to add or update the security email for your .gov domain. 
...
CISA released a [directive](https://www.cisa.gov/news-events/directives/bod-20-01-develop-and-publish-vulnerability-disclosure-policy) to federal agencies that requires VDPs. The directive offers a comprehensive framework for how your organization could support a VDP.

[View our vulnerability disclosure policy](../vulnerability-disclosure-policy/) is available at https://beta.get.gov/vulnerability-disclosure-policy/. 
